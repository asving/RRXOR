"""PCFG-4 (entropic Dirichlet tree, alpha=0.3) training: dense vs hard-only (b >= 2)."""
import argparse, json, os
import torch
import torch.nn.functional as F
from train_multi import GPTV
from pcfg2 import CLS, NLEAF, NTREE, V
from pcfg4 import ALPHA, dirichlet_tables, gen_batch4

P4 = dirichlet_tables(ALPHA)
...
def main():
    ...
    name = f"pcfg4_{args.mask}_seed{args.seed}"
    ...
    json.dump({"mask": args.mask, "seed": args.seed, "L": L, "nl": nl, "vocab": V,
               "steps": args.steps, "batch": Bt, "lr": 3e-4, "gseed": 11,
               "alpha": ALPHA},
