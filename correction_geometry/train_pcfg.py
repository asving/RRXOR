"""PREREG8 Part B: PCFG training, dense vs hard-only (class b>=3) loss."""
import argparse, json, os
import torch
import torch.nn.functional as F
from train_multi import GPTV
from pcfg import gen_batch_pcfg, CLS, NLEAF, NTREE
...
def main():
    ...
    name = f"pcfg_{args.mask}_seed{args.seed}"
